...
test_game_logic: tests/test_game_logic.cpp $(LIB_SRC) controller/poker_controller.cpp view/cli_view.cpp view/ascii_art.cpp animation/spinner.cpp animation/card_animation.cpp
	$(CXX) $(CXXFLAGS) tests/test_game_logic.cpp $(LIB_SRC) controller/poker_controller.cpp view/cli_view.cpp view/ascii_art.cpp animation/spinner.cpp animation/card_animation.cpp -o $(TEST_GAME)
	./$(TEST_GAME)
